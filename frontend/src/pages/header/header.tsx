...
function Header(): React.ReactElement {
    ...
    return (
        <header>
            ...
            {/* Ao clicar no título, volta para o jogo (Home) */}
            <h1 onClick={() => navigate('/')} style={{cursor: 'pointer'}}>DECIFRA</h1>

            <div className="right-icons">
                {/* Ícone de Gráfico (DASHBOARD) */}
                <div className="icon" onClick={() => navigate('/dashboard')} style={{cursor: 'pointer'}}>
